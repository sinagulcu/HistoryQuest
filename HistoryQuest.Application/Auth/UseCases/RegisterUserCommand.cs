...
public class RegisterUserCommand
{
    ...
    public RegisterUserCommand(IUserRepository userRepository, IPasswordHasher passwordHasher)
    {
    ...
    public async Task<AuthResult> ExecuteAsync(RegisterRequest request)
    {
        ...
        var studentRole = new Role(UserRoleType.Student);
        ...
        return new AuthResult
        {
            ...
            AccessToken = string.Empty, //Login'de dolacak
